			...
			<div class="col-md-10">
				<div class="panel panel-primary">
					<div class="panel-heading">
						<h3 class="panel-title text-center">二级学科管理</h3>
					</div>
					<table class="table table-hover table-bordered table-condensed">
						<tr>
							...
							<th>父学科</th>
							<th>操作者</th>
							<th colspan="4" class="text-center">操作</th>
						</tr>
						<c:forEach items="${list}" var="entry">
							<tr>
								...
								<td>${entry.parent }</td>
								<td>${entry.mender }</td>
								<td><a href="${pageContext.request.contextPath }/channel/admin/channels?level=3&cid=${entry.id}" class="btn btn-success btn-sm">管理子学科</a></td>
								<td><a href="#" class="btn btn-success btn-sm">管理版主</a></td>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" id="addChannelModelLabel">添加二级学科</h4>
				</div>
				<div class="modal-body">
					...
					<form role="form" class="form-horizontal" id="addChannelForm" onkeydown="if(event.keyCode==13){return false;}">
						<input type="hidden" class="form-control" name="cid" value="${cid }"> <input type="hidden" class="form-control" name="level" value="2">
