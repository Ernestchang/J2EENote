		...
		<script type="text/javascript">
			$(document).ready(function() {
				$("#dept").change(function() {
					...
					if(deptId != "") {
						$.post("ManagerServlet",{cmd:"getCourseJSON",deptId:deptId},function(data,textStatus) {						
				...
				$("#query_button").click(function(){
					...
					if(b) {
						...
						$.post("ManagerServlet",{cmd:"queryPass",schoolYear:schoolYear,schoolTerm:schoolTerm,courseId:courseId},function(data,textStatus) {
							var dataObj = eval("("+data+")");
							for ( var i = 0; i < dataObj.length; i++) {
								...
								var $caoZuoTd = $("<td></td>");
								var $aNode = $("<a></a>");
								$aNode.attr("href","ManagerServlet?cmd=detail&experimentId=" + experimentId);
								$aNode.text("查看");
