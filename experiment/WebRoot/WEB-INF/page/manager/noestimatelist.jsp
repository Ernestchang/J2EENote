			...
			$(document).ready(function() {
				$("#query_button").click(function(){
					...
					if(b) {
						...
						$.post("ManagerServlet",{cmd:"queryNoEstimate",schoolYear:schoolYear,schoolTerm:schoolTerm,courseId:courseId},function(data,textStatus) {
							...
							for ( var i = 0; i < dataObj.length; i++) {
								...
								var $caoZuoTd = $("<td></td>");
								var $aNode = $("<a></a>");
								$aNode.attr("href","ManagerEstimateServlet?cmd=goEstimateUI&experimentId=" + experimentId);
								$aNode.text("审核");
