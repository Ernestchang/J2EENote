			...
			$(document).ready(function() {
				$("#query_button").click(function(){
					...
					if(b) {
						...
						$.post("ManagerServlet",{cmd:"queryNoPass",schoolYear:schoolYear,schoolTerm:schoolTerm,courseId:courseId},function(data,textStatus) {
				...
				$("#experimentList input").live("click", function(event) {
					...
					$.post("ManagerServlet?cmd=delete&experimentId=" + experimentId,function(data,textStatus) {
						alert(data);
						if("success"==data) {
							$("#query_button").click();
						} else {
