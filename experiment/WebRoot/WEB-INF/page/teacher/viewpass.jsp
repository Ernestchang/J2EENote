...
<html>
		...
		<script type="text/javascript">
			$(document).ready(function() {
				$("#dept").change(function() {
					...
					if(deptId != "") {
						$.post("TeacherServlet",{cmd:"getCourseJSON",deptId:deptId},function(data,textStatus) {						
				...
				$("#query_button").click(function(){
					...
					if(b) {
						...
						$.post("TeacherServlet",{cmd:"queryPass",schoolYear:schoolYear,schoolTerm:schoolTerm,courseId:courseId},function(data,textStatus) {
							var dataObj = eval("("+data+")");
							for ( var i = 0; i < dataObj.length; i++) {
								...
								var $caoZuoTd = $("<td></td>");
								var $aNode = $("<a></a>");
								$aNode.attr("href","TeacherServlet?cmd=detail&experimentId=" + experimentId);
								$aNode.text("查看");
	...
	<body>
		...
		<div class="common_center">
			<%--左边 --%>
			<jsp:include page="/WEB-INF/page/teacher/left.jsp"></jsp:include>
			<%--右边 --%>
			<div class="common_right">
				<div class="common_position">
					<ul><li>当前位置--查看实验项目</li></ul>
				</div>
