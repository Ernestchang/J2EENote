			...
			$(document).ready(function() {
				...
				$("#query_button").click(function(){
					...
					if(b) {
						...
						$.post("HeadmanServlet",{cmd:"queryPass",schoolYear:schoolYear,schoolTerm:schoolTerm,courseId:courseId},function(data,textStatus) {
							var dataObj = eval("("+data+")");
							for ( var i = 0; i < dataObj.length; i++) {
								...
								var $caoZuoTd = $("<td></td>");
								var $aNode = $("<a></a>");
								$aNode.attr("href","HeadmanServlet?cmd=detail&experimentId=" + experimentId);
								$aNode.text("查看");
