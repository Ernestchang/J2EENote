		...
		<script type="text/javascript">
			$(document).ready(function() {
				$("#dept").change(function() {
					...
					if(deptId != "") {
						$.post("ExpertServlet",{cmd:"getCourseJSON",deptId:deptId},function(data,textStatus) {						
				...
				$("#query_button").click(function(){
					...
					if(b) {
						...
						$.post("ExpertServlet",{cmd:"queryNoExtimate",schoolYear:schoolYear,schoolTerm:schoolTerm,courseId:courseId},function(data,textStatus) {
							var dataObj = eval("("+data+")");
							for ( var i = 0; i < dataObj.length; i++) {
								...
								var $caoZuoTd = $("<td></td>");
								var $aNode = $("<a></a>");
								$aNode.attr("href","ExpertEstimateServlet?cmd=goEstimateUI&experimentId=" + experimentId);
								$aNode.text("评审");
